...
<div class="max-w-sm bg-white border border-gray-200 rounded-lg  relative hover:shadow dark:bg-gray-800 dark:border-gray-700">
    <div class="p-5">
            ...
            <div class ="" ><a href="./gestionOffre/updateOffre.php?id=<?php echo $offre->id ?>" class="text-blue-600">Modifier </a> | <a href="../../Controllers/recruteur/deletOffre.php?id=<?php echo $offre->id ?>" class="text-rose-700"> Supremer</a></div>
